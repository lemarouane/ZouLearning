...
<head>
    ...
    <title>Add Subject - Zouhair E-Learning</title>
    ...
    <main class="dashboard">
        ...
        <form method="POST" class="form-container">
            <div class="form-group">
                <label><i class="fas fa-book-open"></i> Subject Name</label>
                <input type="text" name="name" placeholder="e.g., Maths" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn-action"><i class="fas fa-save"></i> Add Subject</button>
