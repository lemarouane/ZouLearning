...
<head>
    ...
    <title>Archives des QCM - Zouhair E-Learning</title>
...
<body>
    ...
    <main class="dashboard">
        <h1><i class="fas fa-archive"></i> Archives des QCM</h1>
        ...
        <?php endif; ?>
        <a href="manage_qcm.php" class="btn-action back"><i class="fas fa-arrow-left"></i> Retour aux QCM</a>
        <table id="archivedQcmTable" class="course-table">
            <thead>
                <tr>
                    <th>Titre</th>
                    <th>Matière</th>
                ...
                <?php while ($qcm = $qcms->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="restore_qcm.php?id=<?php echo $qcm['id']; ?>" class="btn-action restore" title="Restaurer" onclick="return confirm('Êtes-vous sûr de vouloir restaurer ce QCM ? Il sera remis dans la liste principale.');"><i class="fas fa-undo"></i></a>
