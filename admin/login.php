...
<head>
    ...
    <title>Connexion Admin - Zouhair E-Learning</title>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="../assets/img/signin-image.jpg" alt="Connexion Admin"></figure>
                    </div>
                    <div class="signin-form">
                        <h2 class="form-title"><i class="zmdi zmdi-shield"></i> Hello    Admin</h2>
                        <?php if ($error): ?>
